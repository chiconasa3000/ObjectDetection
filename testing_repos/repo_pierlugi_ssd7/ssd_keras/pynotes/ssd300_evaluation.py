...
get_ipython().system('wget https://drive.google.com/open?id=121-kCXaOHOkJE_Kf5lKcJvC_5q1fYb_q -P weights')
...
get_ipython().system('wget http://host.robots.ox.ac.uk/pascal/VOC/voc2012/VOCtrainval_11-May-2012.tar')
get_ipython().system('wget http://host.robots.ox.ac.uk/pascal/VOC/voc2007/VOCtrainval_06-Nov-2007.tar')
get_ipython().system('wget http://host.robots.ox.ac.uk/pascal/VOC/voc2007/VOCtest_06-Nov-2007.tar')
get_ipython().system('mkdir ../datasets/VOC/')
get_ipython().system('tar -xf VOCtrainval_06-Nov-2007.tar -d ../datasets/VOC')
get_ipython().system('tar -xf VOCtrainval_11-May-2012.tar -d ../datasets/VOC')
get_ipython().system('tar -xf VOCtest_06-Nov-2007.tar -d ../datasets/VOC')
get_ipython().system('rm -r *.tar')
...
Pascal_VOC_dataset_images_dir = '../datasets/VOC/VOCdevkit/VOC2007/JPEGImages/'
Pascal_VOC_dataset_annotations_dir = '../datasets/VOC/VOCdevkit/VOC2007/Annotations/'
Pascal_VOC_dataset_image_set_filename = '../datasets/VOC/VOCdevkit/VOC2007/ImageSets/Main/test.txt'
