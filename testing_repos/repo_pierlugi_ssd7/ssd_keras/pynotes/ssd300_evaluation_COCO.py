...
get_ipython().system('mkdir ../datasets/MicrosoftCOCO/')
get_ipython().system('unzip val2017.zip -d ../datasets/MicrosoftCOCO/')
get_ipython().system('unzip annotations_trainval2017.zip -d ../datasets/MicrosoftCOCO/')
