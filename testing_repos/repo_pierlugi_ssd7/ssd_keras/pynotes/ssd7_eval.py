...
# Ground truth
train_labels_filename = '../datasets/udacity/udacity_driving_datasets/labels_train.csv'
val_labels_filename   = '../datasets/udacity/udacity_driving_datasets/labels_val.csv'
