...
weights_destination_path = '../weights/VGG_coco_SSD_300x300_iter_400000_subsampled_8_classes.h5'
...
for name in classifier_names:
    ...
    with h5py.File(weights_destination_path,"a") as f1:
        del f1[name][name]["kernel:0"]
        del f1[name][name]['bias:0']
...
get_ipython().system('wget http://bit.ly/udacity-annoations-crowdai')
...
images_path = '../datasets/udacity_driving_datasets/'
labels_path = '../datasets/udacity_driving_datasets/labels_train.csv'
