...
#model_path = '../../datasets/udacity/weights/ssd7_epoch-28_loss-1.8966_val_loss-2.1094.h5'
...
# Images
images_dir = '../datasets/udacity/udacity_second_datasets/'

# Ground truth
train_labels_filename = '../datasets/udacity/labels/labelsmod/labels_train.csv'
val_labels_filename   = '../datasets/udacity/labels/labelsmod/labels_val.csv'
...
classes = ['background', 'car', 'pedestrian', 'light'] # Just so we can print class names onto the image instead of IDs
